...
const AllProduct = () => {
  ...
  return loading ? (
    <Box h="100vh" opacity="0.5" w="100wh" pos={'relative'}>
      <Image
        pos={'absolute'}
        top="15%"
        left="40%"
        m="100px auto"
        bgColor={'transparent'}
        src="https://media.tenor.com/On7kvXhzml4AAAAj/loading-gif.giff"
      />
    </Box>
  ) : error ? (
    <ErrorPage />
        ...
        >
          {prod.map((el) => {
            ...
            const discount = Math.round(
              ((crossed_price - actual_price) / crossed_price) * 100,
            )
            return (
              <GridItem
                key={id}
                w="100%"
                p={'14px 16px 15px 16px'}
              ...
              >
                ...
                <Image
                  ...
                  src={
                    img1
                      ? img1
                      : 'https://www.netmeds.com/images/product-v1/600x600/default/no_image.png'
                  }
                  cursor="pointer"
                  onClick={() => handleProductDetail(el)}
                />
                <Text
                  mt="5px"
                  overflow={'hidden'}
                ...
                <Text fontSize={'14px'} color="#6f7284" fontWeight={'700'}>
                  Best price*{' '}
                  <Text as="span" fontSize="16px" color="#ef4281">
                    ₹{actual_price}
                  </Text>
                </Text>
                <Box h="40px">
                  {crossed_price && (
                    <Text fontSize={'13px'} padding="5px 0" color="#6f7284">
                      MRP
                      <Text as="span" textDecor={'line-through'} p="0 5px">
                        Rs.{crossed_price}
                      </Text>
                    </Text>
                  )}
                ...
                <Button
                  ...
                  color="white"
                  textTransform={'uppercase'}
                  _hover={{ bgColor: '#24aeb1', color: 'white' }}
                  onClick={() => {
                    handleAdd(el)
                  }}
                >
          ...
          >
            {page !== 1 && (
              <Button
                ...
                p="0 20px"
                fontWeight={'400'}
                _hover={{ color: '#0298a7', bgColor: 'white' }}
                fontSize={'13px'}
                color="#151b39"
            ...
            )}
            {
              <Button
                ...
                size={'sm'}
                _hover={{ color: '#0298a7', bgColor: '#D4D5D940' }}
                bgColor="white"
                fontWeight={'400'}
                fontSize={'13px'}
                color="#151b39"
